...
module RushHour
  class UserCanSeeClientSpecificUrlStatsTest < Minitest::Test
    ...
    def test_user_can_see_statistics_for_url_specific_to_client
      ...
      assert page.has_content?("Response Times Across All Requests (longest to shortest):")
      assert page.has_content?("[65, 60]")
      assert page.has_content?("Average Response Time for URL:")
      assert page.has_content?("62.5")
      assert page.has_content?("HTTP Verbs Associated with URL:")
